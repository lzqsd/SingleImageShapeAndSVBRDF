...
parser.add_argument('--modelRootGlob', default=None, help='the path to store global illumination prediction network')
# The basic testing setting
parser.add_argument('--epochId', type=int, default=14, help='the number of epochs for testing')
parser.add_argument('--epochIdGlob', type=int, default=17, help='the training epoch of the global illumination prediction')
...
if opt.experiment is None:
    opt.experiment = 'output_initEnvGlob'
    opt.experiment += '_cascade0_' + opt.dataRoot.split('/')[-1]
